...
@Entity
@Table(name = "ADMIN_CARS_TYPE",schema="FUNDS_BANK")
public class AdminCarsTypeDomain implements Serializable {
	@Id
	@Column(name = "ID",nullable = true)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_ADMIN_CARS_TYPE")
	@SequenceGenerator(name = "SEQ_ADMIN_CARS_TYPE", sequenceName = "SEQ_ADMIN_CARS_TYPE", allocationSize = 1, schema = "FUNDS_BANK")
	private Long id;
